...
const FLASH_WRITER_F4_CODE_X8 = new Uint8Array([
    // write:
    0x03,
    0x78, // 0x7803    // ldrh r3, [r0]
    0x0b,
    0x70, // 0x700b    // strh r3, [r1]
    // test_busy:
    0x23,
    0x68, // 0x6823    // ldr r3, [r4]
    0x2b,
    0x42, // 0x422b    // tst r3, r5
    0xfc,
    0xd1, // 0xd1fc    // bne <test_busy>
    0x00,
    0x2b, // 0x2b00    // cmp r3, //0
    0x04,
    0xd1, // 0xd104    // bne <exit>
    0x01,
    0x30, // 0x3001    // adds r0, //1
    0x01,
    0x31, // 0x3101    // adds r1, //1
    0x01,
    0x3a, // 0x3a01    // subs r2, //1
    0x00,
    0x2a, // 0x2a00    // cmp r2, //0
    0xf3,
    0xd1, // 0xd1f3    // bne <write>
    // exit:
    0x00,
    0xbe, // 0xbe00    // bkpt 0x00
]);

const FLASH_WRITER_F4_CODE_X16 = new Uint8Array([
    // write:
    0x03,
    0x88, // 0x8803    // ldrh r3, [r0]
    0x0b,
    0x80, // 0x800b    // strh r3, [r1]
    // test_busy:
    0x23,
    0x68, // 0x6823    // ldr r3, [r4]
    0x2b,
    ...
    0xd1, // 0xd104    // bne <exit>
    0x02,
    0x30, // 0x3002    // adds r0, //2
    0x02,
    0x31, // 0x3102    // adds r1, //2
    0x02,
    0x3a, // 0x3a02    // subs r2, //2
    0x00,
    0x2a, // 0x2a00    // cmp r2, //0
    0xf3,
    0xd1, // 0xd1f3    // bne <write>
...
const FLASH_WRITER_F4_CODE_X32 = new Uint8Array([
    // write:
    0x03,
    0x68, // 0x6803    // ldr r3, [r0]
    0x0b,
    0x60, // 0x600b    // str r3, [r1]
    // test_busy:
    0x23,
    0x68, // 0x6823    // ldr r3, [r4]
    0x2b,
    ...
    0xd1, // 0xd104    // bne <exit>
    0x04,
    0x30, // 0x3004    // adds r0, //4
    0x04,
    0x31, // 0x3104    // adds r1, //4
    0x04,
    0x3a, // 0x3a04    // subs r2, //4
    0x00,
    0x2a, // 0x2a00    // cmp r2, //0
    0xf3,
    0xd1, // 0xd1f3    // bne <write>
...
const VOLTAGE_DEPENDEND_PARAMS = [
    {
        ...
        max_erase_time: { 16: 0.5, 64: 1.1, 128: 2 },
    ...
    },
    {
        ...
        max_erase_time: { 16: 0.6, 64: 1.4, 128: 2.6 },
    ...
    },
    {
        ...
        max_erase_time: { 16: 0.8, 64: 2.4, 128: 4 },
...
class Flash {
    ...
    async get_voltage_dependend_params() {
        ...
        let params = VOLTAGE_DEPENDEND_PARAMS.find((params) => voltage > params["min_voltage"]);
        if (params) {
            return params;
        }
...
class Stm32FS extends Stm32 {
    ...
    async flash_write(addr, data, { erase = false, verify = false, erase_sizes = null }) {
        ...
        this._dbg.debug(
            `Stm32FS.flash_write(${addr_str}, [data:${data.length}Bytes], erase=${erase}, verify=${verify}, erase_sizes=${erase_sizes})`,
        );
        if (addr === null) {
